...
root.geometry(f"{height+455}x{width+25}")
root.configure(bg="black")
froot = tk.Frame(root, borderwidth=0, highlightthickness=0)
froot.grid(row=0, column=0, rowspan=2, padx=10, pady=10)
fconfig = tk.Frame(root)
fconfig.grid(row=0, column=1, padx=10, pady=10)
fconfig_mask = tk.Frame(root)
fconfig_mask.grid(row=1, column=1, padx=10, pady=10)
